...
import com.kcb.mqlService.mqlQueryDomain.mqlOperator.whereOperator.largerThan.LargerThanVC;
...
public class LargerThanEqualToVCTest {
    ...
    public void valueLargerThanEqualToColumnTest() {
        ...
        tableData.forEach(eachRow -> {
            assertThat(2, is(greaterThanOrEqualTo((int)eachRow.get("A.CategoryID"))));
        });
