...
public class LessThanEqualToJoin extends JoinOperator{
    public LessThanEqualToJoin(ColumnOperand leftOperand, ColumnOperand rightOperand) {
    ...
    protected List<Map<String, Object>> join(
        ...
        leftDataSource.forEach(leftRow -> rightDataSource.forEach(rightRow -> {
            ...
            if (leftValue.lessThanOrEqualTo(rightValue)){
